...
const INITIAL_CUSTOMERS: Customer[] = [
  { id: 'c1', code: 'CUST-GSM', name: 'PT. Gregah Sukses Mandiri', address: 'Kawasan Industri Tayan, Sanggau, Kalimantan Barat', phone: '0811-574-889', email: 'procurement@gregahsukses.com', balance: 0 },
  { id: 'c2', code: 'CUST-JPJ', name: 'PT. Jatim Propertindo Jaya', address: 'Jl. Ahmad Yani No. 120, Pontianak, Kalimantan Barat', phone: '0812-9088-771', email: 'finance@jatimpropertindo.co.id', balance: 0 },
  { id: 'c3', code: 'CUST-KLUD', name: 'PT. Kaludeius S (Oktavianus)', address: 'Tayan Hulu, Sanggau, Kalimantan Barat', phone: '0813-4552-110', email: 'oktavianus@kaludeius.com', balance: 0 },
];

const INITIAL_SUPPLIERS: Supplier[] = [
  { id: 's1', code: 'SPL-CONCH', name: 'PT. Semen Conch Indonesia', address: 'Kawasan Industri Merak, Cilegon (Distributor Kalbar)', phone: '021-3990881', email: 'sales@conchsemen.id', balance: 0 },
  { id: 's2', code: 'SPL-BOMA', name: 'CV. Boma Batu Split', address: 'Bukit Batu, Tayan Hilir, Kalimantan Barat', phone: '0815-2244-119', email: 'boma.split@gmail.com', balance: 0 },
  { id: 's3', code: 'SPL-KOKO', name: 'Toko Koko Material', address: 'Pasar Tayan, Sanggau, Kalimantan Barat', phone: '0852-9988-112', email: 'koko.toko@outlook.com', balance: 0 },
];

const INITIAL_PRODUCTS: Product[] = [
  { id: 'p1', sku: 'PRD-CONC', name: 'Ready Mix Concrete K-300 (M3)', category: 'Concrete', unit: 'M3', costPrice: 920000, sellingPrice: 1350000, stock: 1540, warehouse: 'Stockpile Utama Tayan' },
  { id: 'p2', sku: 'PRD-SPLIT', name: 'Batu Split 1x2 (M3)', category: 'Material', unit: 'M3', costPrice: 195000, sellingPrice: 280000, stock: 850, warehouse: 'Stockpile Batu & Pasir' },
  { id: 'p3', sku: 'PRD-PASIR', name: 'Pasir Cor Pilihan (M3)', category: 'Material', unit: 'M3', costPrice: 45000, sellingPrice: 65000, stock: 1200, warehouse: 'Stockpile Batu & Pasir' },
  { id: 'p4', sku: 'PRD-SEMEN', name: 'Semen Conch Portland (Zak)', category: 'Material', unit: 'Zak', costPrice: 58000, sellingPrice: 77000, stock: 2400, warehouse: 'Stockpile Utama Tayan' },
  { id: 'p5', sku: 'PRD-OBAT', name: 'Obat Beton / Admixture (Drum)', category: 'Material', unit: 'Drum', costPrice: 4262400, sellingPrice: 5500000, stock: 10, warehouse: 'Stockpile Utama Tayan' },
];
...
const INITIAL_SALES: SalesInvoice[] = [
  {
    id: 'inv-s1',
    invoiceNo: 'INV-S-202601001',
    date: '2026-01-13',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 115, price: 1346000, subtotal: 154800000 }],
    subtotal: 154800000,
    tax: 0,
    total: 154800000,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 154800000,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s2',
    invoiceNo: 'INV-S-202601002',
    date: '2026-01-14',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 119, price: 1347594, subtotal: 160363750 }],
    subtotal: 160363750,
    tax: 0,
    total: 160363750,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 160363750,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s3',
    invoiceNo: 'INV-S-202601003',
    date: '2026-01-20',
    customerId: 'c2',
    items: [{ productId: 'p1', qty: 440, price: 1350000, subtotal: 593999999 }],
    subtotal: 593999999,
    tax: 0,
    total: 593999999,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 593999999,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s4',
    invoiceNo: 'INV-S-202601004',
    date: '2026-01-20',
    customerId: 'c2',
    items: [{ productId: 'p1', qty: 115, price: 1346000, subtotal: 154800000 }],
    subtotal: 154800000,
  ...
  {
    id: 'inv-s5',
    invoiceNo: 'INV-S-202601005',
    date: '2026-01-21',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 77, price: 1351414, subtotal: 104058900 }],
    subtotal: 104058900,
    tax: 0,
    total: 104058900,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 104058900,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s6',
    invoiceNo: 'INV-S-202601030',
    date: '2026-01-30',
    customerId: 'c2',
    items: [{ productId: 'p1', qty: 513, price: 1350877, subtotal: 692999999 }],
    subtotal: 692999999,
    tax: 0,
    total: 692999999,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 692999999,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s7',
    invoiceNo: 'INV-S-202602001',
    date: '2026-02-02',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 180, price: 1348911, subtotal: 242804100 }],
    subtotal: 242804100,
    tax: 0,
    total: 242804100,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 242804100,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s8',
    invoiceNo: 'INV-S-202602002',
    date: '2026-02-13',
    customerId: 'c2',
    items: [{ productId: 'p1', qty: 513, price: 1350877, subtotal: 692999999 }],
    subtotal: 692999999,
  ...
  {
    id: 'inv-s9',
    invoiceNo: 'INV-S-202602003',
    date: '2026-02-13',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 37, price: 1350000, subtotal: 49950000 }],
    subtotal: 49950000,
    tax: 0,
    total: 49950000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-s10',
    invoiceNo: 'INV-S-202602004',
    date: '2026-02-25',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 71, price: 1355869, subtotal: 96266700 }],
    subtotal: 96266700,
    tax: 0,
    total: 96266700,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-s11',
    invoiceNo: 'INV-S-202603001',
    date: '2026-03-16',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 126, price: 1349771, subtotal: 170071170 }],
    subtotal: 170071170,
    tax: 0,
    total: 170071170,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 170071170,
    branch: 'Site Ready Mix'
  },
  {
    id: 'inv-s12',
    invoiceNo: 'INV-S-202604001',
    date: '2026-04-17',
    customerId: 'c1',
    items: [{ productId: 'p1', qty: 35, price: 1356794, subtotal: 47487800 }],
    subtotal: 47487800,
    tax: 0,
    total: 47487800,
    paymentMethod: 'CASH',
...
const INITIAL_PURCHASES: PurchaseInvoice[] = [
  {
    id: 'inv-p1',
    invoiceNo: 'INV-P-202601001',
    date: '2026-01-16',
    supplierId: 's1',
    items: [{ productId: 'p4', qty: 564, price: 58000, subtotal: 32700000 }],
    subtotal: 32700000,
    tax: 0,
    total: 32700000,
    paymentMethod: 'CASH',
    status: 'Paid',
    amountPaid: 32700000,
    branch: 'Kantor Cabang Tayan'
  },
  {
    id: 'inv-p2',
    invoiceNo: 'INV-P-202601002',
    date: '2026-01-18',
    supplierId: 's1',
    items: [{ productId: 'p4', qty: 845, price: 58000, subtotal: 49050000 }],
    subtotal: 49050000,
    tax: 0,
    total: 49050000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p3',
    invoiceNo: 'INV-P-202601003',
    date: '2026-01-18',
    supplierId: 's1',
    items: [{ productId: 'p5', qty: 10, price: 4262400, subtotal: 42624000 }],
    subtotal: 42624000,
    tax: 0,
    total: 42624000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p4',
    invoiceNo: 'INV-P-202601004',
    date: '2026-01-18',
    supplierId: 's2',
    items: [{ productId: 'p3', qty: 248, price: 65000, subtotal: 16120000 }],
    subtotal: 16120000,
    tax: 0,
    total: 16120000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p5',
    invoiceNo: 'INV-P-202601005',
    date: '2026-01-18',
    supplierId: 's2',
    items: [{ productId: 'p2', qty: 100, price: 280000, subtotal: 28000000 }],
    subtotal: 28000000,
    tax: 0,
    total: 28000000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p6',
    invoiceNo: 'INV-P-202601006',
    date: '2026-01-17',
    supplierId: 's2',
    items: [{ productId: 'p2', qty: 30, price: 280000, subtotal: 8400000 }],
    subtotal: 8400000,
    tax: 0,
    total: 8400000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p7',
    invoiceNo: 'INV-P-202601091',
    date: '2026-01-09',
    supplierId: 's2',
    items: [{ productId: 'p2', qty: 70, price: 280000, subtotal: 19600000 }],
    subtotal: 19600000,
    tax: 0,
    total: 19600000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p8',
    invoiceNo: 'INV-P-202601092',
    date: '2026-01-09',
    supplierId: 's1',
    items: [{ productId: 'p4', qty: 568, price: 58000, subtotal: 33000000 }],
    subtotal: 33000000,
    tax: 0,
    total: 33000000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p9',
    invoiceNo: 'INV-P-202601141',
    date: '2026-01-14',
    supplierId: 's1',
    items: [{ productId: 'p4', qty: 1189, price: 58000, subtotal: 69000000 }],
    subtotal: 69000000,
    tax: 0,
    total: 69000000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p11',
    invoiceNo: 'INV-P-202602021',
    date: '2026-02-02',
    supplierId: 's1',
    items: [{ productId: 'p4', qty: 1718, price: 58000, subtotal: 99664000 }],
    subtotal: 99664000,
    tax: 0,
    total: 99664000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p12',
    invoiceNo: 'INV-P-202602022',
    date: '2026-02-02',
    supplierId: 's2',
    items: [{ productId: 'p3', qty: 247, price: 65000, subtotal: 16055000 }],
    subtotal: 16055000,
    tax: 0,
    total: 16055000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p13',
    invoiceNo: 'INV-P-202602023',
    date: '2026-02-02',
    supplierId: 's2',
    items: [{ productId: 'p2', qty: 150, price: 280000, subtotal: 42000000 }],
    subtotal: 42000000,
    tax: 0,
    total: 42000000,
    paymentMethod: 'CASH',
  ...
  {
    id: 'inv-p14',
    invoiceNo: 'INV-P-202602041',
    date: '2026-02-04',
    supplierId: 's1',
    items: [{ productId: 'p4', qty: 200, price: 77100, subtotal: 15420000 }],
    subtotal: 15420000,
    tax: 0,
    total: 15420000,
    paymentMethod: 'CASH',
