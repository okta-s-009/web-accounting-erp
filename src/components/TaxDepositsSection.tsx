      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-[#06060f] border border-white/[0.08] rounded-2xl p-5 shadow-xl space-y-4">
            ...
            {/* Filters Row */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 bg-zinc-900/30 p-3.5 rounded-xl border border-white/[0.06]">
            ...
            {filteredDeposits.length === 0 ? (
              ...
              <div className="space-y-3 max-h-[580px] overflow-y-auto pr-1">
                {filteredDeposits.map((item) => (
                  <div
                    key={item.id}
                    className="p-4 bg-[#0a0a1a]/80 border border-white/[0.08] hover:border-white/[0.1]/80 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all"
                  >
