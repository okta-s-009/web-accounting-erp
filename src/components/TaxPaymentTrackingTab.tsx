        ...
        {notification && (
          ...
          >
            <div className={`p-4 rounded-xl shadow-xl border flex items-start gap-3 text-left ${
              ...
              <div>
                <p className="text-[11px] font-black uppercase tracking-wider">Notifikasi Sistem</p>
          ...
          <div id="ssp-form-container" className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5 shadow-xl space-y-4">
            <div className="border-b border-zinc-900 pb-3 flex items-center justify-between">
              ...
              <button
                ...
                className="px-2 py-1 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/20 rounded-lg text-[8px] font-black text-amber-400 uppercase tracking-wider flex items-center gap-1 transition-colors cursor-pointer"
              >
              ...
              <div className="flex gap-2">
                {editingDepositId && (
                  <button
                    ...
                    className="flex-1 py-3 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-xs font-black uppercase rounded-xl tracking-wider shadow-lg flex items-center justify-center gap-1.5 transition-all cursor-pointer mt-2"
                  >
                    Batal
                  </button>
                )}
          ...
          >
            ...
            >
              ...
              <div className="text-center py-5 relative z-10">
                <h3 className="text-sm md:text-base font-black tracking-widest text-zinc-100 uppercase">
